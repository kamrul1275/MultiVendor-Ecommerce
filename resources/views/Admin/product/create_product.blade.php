                  ...
                  <div class="col-lg-8">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                         ...
                         <textarea class="form-control" name="short_descript" id="inputProductDescription" rows="3"></textarea>
                      </div>


                      <div class="mb-3">
                        <label for="inputProductDescription" class="form-label">Long Description</label>
                        <textarea id="mytextarea" name="long_descript">Hello, World!</textarea>
                     </div>
...
{{-- start tag --}}
                ...
                <div class="mb-3">
                    ...
                    <label for="inputProductTitle" class="form-label">Product Tags</label>
                        ...
                        <input type="text" name="product_tags" class="form-control visually-hidden" data-role="tagsinput" value="Hot_sales,Top_Sales,Featured">
                </div>
...
{{-- end tah --}}
            ...
            <div class="mb-3">
                <label class="form-label">Product Qunty</label>


                    <input type="text" name="product_qty" class="form-control visually-hidden" data-role="tagsinput" value="1,2,3">
            </div>
          ...
          <div class="row" id="preview_img"></div>
               ...
               <div class="row g-3">
                         <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                              <label for="inputStarPoints" class="form-label">Product Qtny</label>
                              <input type="text" name="" class="form-control" id="inputStarPoints" placeholder="00.00">
                           </div>
					...
					<select name="subcategory_id" class="form-select" id="subcategory_id">
                           ...
                           <div class="col-12">
                            <label for="inputCollection" class="form-label">Vendor id</label>
                            <select class="form-select" name="vendor_id" id="inputCollection">
                                @foreach ($activeVendors as $activeVendor)
                                <option value="{{ $activeVendor->id }}">{{ $activeVendor->name }}</option>
                         ...
                         <div class="col-md-6">
                              ...
                              <label for="inputCostPerPrice" class="form-label">Hot Deals</label>
                           </div>

                           <div class="col-md-6">
                              <input class="form-check-input" type="checkbox"   value="1" id="flexCheckDefault">
                              <label for="inputStarPoints"  class="form-label"> Special Offer</label>
                           ...
                           <div class="col-md-6">
                              ...
                              <label for="inputCostPerPrice" class="form-label">Featured</label>
                           </div>

                           <div class="col-md-6">
                              <input class="form-check-input" type="checkbox" name="speacial_deals" value="1" id="flexCheckDefault">
                              <label for="inputStarPoints" class="form-label"> Special Deals</label>
