                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="POST" action="{{ route('vendor.register.store') }}">
                                            ...
                                            <div class="form-group" >
                                                ...
                                                name="join_date"   aria-label="Default select example">
                                                    <option  selected="">Open this select menu</option>
                                                    <option  name="join_date" value="1">2022</option>
                                                    <option  name="join_date" value="2">2023</option>
                                                    <option  name="join_date" value="3">2024</option>
                                                </select>
